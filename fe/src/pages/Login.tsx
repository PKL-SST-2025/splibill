      ...
      <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
          ...
          <div class="bg-gray-900/20 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-red-700/30 hover:bg-gray-800/25 transition-all duration-500">
            ...
            {/* Warning Message */}
            {showWarning() && (
              <div class="mb-4 bg-red-500/20 backdrop-blur-sm rounded-2xl p-4 border border-red-400/30 animate-pulse">
                <div class="flex items-center gap-3">
                  <AlertCircle class="w-5 h-5 text-red-400" />
                  <span class="text-red-100 text-sm font-medium">{warningMessage()}</span>
                </div>
              </div>
            )}

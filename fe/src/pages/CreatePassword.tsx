            ...
            {!isCreated() ? (
              ...
              <>
                ...
                <div class="relative mb-6">
                  ...
                  <div class="relative w-24 h-24 mx-auto rounded-full border-4 border-green-400/50 overflow-hidden bg-gradient-to-br from-green-500 to-green-600 shadow-2xl flex items-center justify-center">

...
export default function CreateAccountPage() {
  ...
  return (
    <div class="min-h-screen bg-black relative overflow-hidden">
      {/* Background animation dengan warna merah - sama seperti login */}
      <div class="absolute inset-0 overflow-hidden">
        ...
        <div class="absolute top-1/3 right-1/4 w-64 h-64 bg-red-800/15 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
        ...
        <div class="w-full max-w-md">
          ...
          <div class="bg-gray-900/20 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-red-700/30 hover:bg-gray-800/25 transition-all duration-500">
            ...
            <div class="relative mb-6">
              ...
              <div class="relative w-28 h-28 mx-auto rounded-full border-4 border-red-700/50 overflow-hidden bg-gradient-to-br from-red-800 to-red-900 shadow-2xl">
                <div class="w-full h-full bg-gradient-to-br from-red-800/80 to-red-900/80 flex items-center justify-center">
            ...
            <div class="text-center mb-8">
              ...
              <p class="text-red-100 text-sm">Create your account and start splitting bills beautifully</p>
            </div>
            ...
            <div class="relative mb-4 group">
              ...
              <div class={`relative flex items-center bg-gray-900/20 backdrop-blur-sm rounded-2xl px-4 py-4 border transition-all duration-300 ${
                fieldErrors().username 
                  ...
                  : 'border-red-700/30 group-focus-within:border-red-700/60'
              }`}>
            ...
            <div class="flex items-start gap-3 mb-8">
              <div class="relative mt-1">
                <input
                  ...
                  class="sr-only"
                />
                <div class={`w-5 h-5 rounded-md border-2 border-red-700/50 transition-all duration-300 cursor-pointer ${agreeTerms() ? 'bg-white border-white' : 'bg-gray-900/20'}`}
            ...
            <button
              class={`group relative w-full py-4 rounded-2xl font-bold text-lg transition-all duration-300 shadow-xl overflow-hidden ${
                isFormValid() 
                  ? 'bg-white text-red-800 hover:scale-105 hover:shadow-2xl hover:bg-red-50' 
          ...
          <div class="mt-8 text-center">
            <div class="flex items-center gap-4 mb-4">
              ...
              <span class="text-red-200 text-sm">Or sign up with</span>
              <div class="flex-1 h-px bg-red-700/30"></div>
            </div>
            
            <div class="flex gap-4 justify-center">
              {["G", "F", "A"].map((text) => (
                <button class="bg-gray-900/20 backdrop-blur-sm rounded-xl p-3 border border-red-700/30 hover:bg-gray-800/30 hover:border-red-700/60 transition-all duration-300 hover:scale-105">

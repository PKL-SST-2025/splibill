    ...
    <div class="min-h-screen bg-black text-white overflow-hidden font-sans">
      ...
      <nav class="relative z-50 flex items-center justify-between px-6 lg:px-12 py-6 bg-black/90 backdrop-blur-md w-full top-0">
        <div class="text-2xl font-bold flex items-center space-x-2">
          <div class="w-10 h-10 bg-gradient-to-r from-red-800 to-red-900 rounded-lg flex items-center justify-center">
            <Receipt />
          </div>
          <span class="text-white">BILLSPLIT</span>
        </div>
        <div class="hidden md:flex items-center space-x-8 text-sm">
          <button onClick={() => scrollToSection('home')} class="text-gray-300 hover:text-red-700 transition-colors cursor-pointer">HOME</button>
          <button onClick={() => scrollToSection('about')} class="text-gray-300 hover:text-red-700 transition-colors cursor-pointer">ABOUT US</button>
          <button onClick={() => scrollToSection('pricing')} class="text-gray-300 hover:text-red-700 transition-colors cursor-pointer">PRICING</button>
          <button onClick={() => scrollToSection('how-it-works')} class="text-gray-300 hover:text-red-700 transition-colors cursor-pointer">HOW IT WORKS</button>
          <button onClick={() => scrollToSection('support')} class="text-gray-300 hover:text-red-700 transition-colors cursor-pointer">SUPPORT</button>
        </div>
        <div class="flex items-center space-x-4">
          <button 
            onClick={navigateToLogin}
            class="bg-red-800 hover:bg-red-900 px-6 py-2 rounded text-white font-medium transition-colors"
          >
            LOGIN
          </button>
          <button 
            onClick={navigateToSignUp}
            class="border border-red-800 hover:bg-red-800/10 px-6 py-2 rounded text-red-700 font-medium transition-colors"
          >
            SIGN UP
          </button>
        </div>
      ...
      <div id="home" class="relative min-h-screen flex items-center pt-20">
        ...
        <div class="absolute inset-0">
          <div class="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-red-950/20 via-red-900/10 to-transparent"></div>
          <div class="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-red-950/10 via-red-900/5 to-transparent"></div>
        </div>
          ...
          <div class="flex flex-col justify-center space-y-8">
            <div class="space-y-6">
              <h1 class="text-5xl lg:text-7xl font-bold leading-tight">
                ...
                <br />
                <span class="bg-gradient-to-r from-red-700 to-red-900 bg-clip-text text-transparent">
                  SPLITTING MADE EASY
                </span>
              </h1>
            ...
            <div class="flex items-center space-x-4 pt-8">
              <div class="w-10 h-10 bg-gray-800 hover:bg-red-800 rounded-full flex items-center justify-center transition-colors cursor-pointer">
          ...
          <div class="flex items-center justify-center relative">
            <div class="relative">
              ...
              <div class="w-72 h-96 relative">
                {/* Glowing background */}
                <div class="absolute inset-0 bg-gradient-to-r from-red-800/20 to-red-900/20 rounded-3xl blur-3xl animate-pulse"></div>
                
                {/* Phone Body */}
                <div class="absolute inset-4 bg-gradient-to-b from-gray-800 to-gray-900 rounded-3xl border border-red-700/30 shadow-2xl overflow-hidden">
                  {/* Screen Header */}
                  <div class="bg-red-800 p-4 text-center">
                    <div class="flex items-center justify-center space-x-2">
                      <Receipt />
                      <span class="text-white font-bold">BillSplit</span>
                    </div>
                  </div>
                  ...
                  <div class="p-6 space-y-4">
                    ...
                    <div class="bg-gray-700/30 rounded-xl p-4 border border-gray-600">
                      <div class="flex justify-between items-center">
                        ...
                        <div class="text-red-600 font-bold">$12.00</div>
                      </div>
                    </div>
                    
                    {/* Add Bill Button */}
                    <button class="w-full bg-red-800/20 border-2 border-dashed border-red-700/50 rounded-xl p-4 flex items-center justify-center space-x-2 hover:bg-red-800/30 transition-colors">
                      <PlusCircle />
                      <span class="text-red-700 font-medium">Add New Bill</span>
                    </button>
                  </div>
                </div>

                {/* Floating Features */}
                <div class="absolute -top-4 -left-8 w-12 h-12 bg-red-800 rounded-full opacity-80 animate-bounce flex items-center justify-center shadow-lg">
                  <Calculator />
                </div>
                <div class="absolute -top-2 -right-6 w-10 h-10 bg-red-900 rounded-full opacity-70 animate-bounce delay-500 flex items-center justify-center shadow-lg">
                  <Users />
                </div>
                <div class="absolute -bottom-4 -left-6 w-11 h-11 bg-red-950 rounded-full opacity-75 animate-bounce delay-1000 flex items-center justify-center shadow-lg">
                  <DollarSign />
                </div>
                <div class="absolute -bottom-2 -right-8 w-12 h-12 bg-red-700 rounded-full opacity-60 animate-bounce delay-1500 flex items-center justify-center shadow-lg">
                  <CheckCircle />
                </div>
              </div>
            </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          ...
          <div class="relative">
            <div class="w-80 h-80 relative mx-auto">
              ...
              <div class="absolute inset-0 bg-gradient-to-r from-red-800/10 to-red-900/10 rounded-2xl blur-2xl animate-pulse"></div>
            </div>
          </div>
          ...
          <div class="space-y-8">
            <div class="space-y-4">
              <h2 class="text-5xl font-bold text-white">About <span class="text-red-700">Us</span></h2>
              <h3 class="text-2xl font-semibold text-red-700">We Make Bill Splitting Simple & Fair</h3>
            </div>
      ...
      <section id="pricing" class="py-20 px-6 lg:px-12">
        <div class="text-center mb-16">
          <h2 class="text-5xl font-bold text-white mb-4">
            <span class="text-red-700">Pricing</span> Plans
          </h2>
        </div>
          ...
          <div class="bg-gray-800 rounded-lg p-1 flex">
            <button 
              ...
              class={`px-6 py-2 rounded font-medium transition-colors ${
                !isYearly() ? 'bg-red-800 text-white' : 'text-gray-400 hover:text-white'
              }`}
            >
              MONTHLY
            </button>
        ...
        <div class="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingPlans.map((plan, index) => (
            <div class={`relative bg-gray-900 rounded-3xl p-8 border-2 transition-all duration-300 transform hover:scale-105 ${
              plan.popular ? 'border-red-700 shadow-lg shadow-red-700/20' : 'border-gray-700 hover:border-red-700/50'
            }`}>
              {plan.popular && (
                <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-red-800 text-white px-4 py-1 rounded-full text-sm font-medium">
                  MOST POPULAR
                </div>
              )}
              ...
              {isYearly() && plan.savings && (
                <div class="absolute -top-2 -right-2 bg-red-900 text-white px-3 py-1 rounded-full text-xs font-medium">
                  {plan.savings}
                </div>
              )}
              
              <div class="text-center mb-8">
                <h3 class="text-2xl font-bold text-red-700 mb-2">{plan.type}</h3>
              ...
              <button class={`w-full py-3 rounded-lg font-medium transition-colors ${
                plan.popular 
                  ...
                  : 'bg-gray-800 hover:bg-red-800 text-gray-300 hover:text-white border border-gray-600 hover:border-red-700'
              }`}>
      ...
      <section id="how-it-works" class="py-20 px-6 lg:px-12 bg-gray-900">
        <div class="text-center mb-16">
          <h2 class="text-5xl font-bold text-white mb-4">
            How It <span class="text-red-700">Works</span>
          </h2>
        ...
        <div class="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div class="text-center space-y-6">
            <div class="w-16 h-16 bg-red-800 rounded-full flex items-center justify-center mx-auto">
      ...
      <section id="support" class="py-20 px-6 lg:px-12">
        <div class="text-center mb-16">
          <h2 class="text-5xl font-bold text-white mb-4">
            Need <span class="text-red-700">Support</span>?
          </h2>
          <p class="text-gray-400 text-lg max-w-2xl mx-auto">
        ...
        <div class="grid lg:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              <input type="email" placeholder="Your email" class="w-full p-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:border-red-700 outline-none" />
              <textarea placeholder="Your message" rows="4" class="w-full p-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:border-red-700 outline-none resize-none"></textarea>
              <button class="w-full bg-red-800 hover:bg-red-900 text-white py-3 rounded-lg font-medium transition-colors">
                Send Message
              </button>
            </div>
          </div>
      ...
      <footer class="py-16 px-6 lg:px-12 bg-gray-900">
        <div class="text-center">
          ...
          <div class="flex justify-center space-x-8 text-gray-400 text-sm">
            <a href="#" class="hover:text-red-700 transition-colors">Privacy Policy</a>
            <a href="#" class="hover:text-red-700 transition-colors">Terms of Service</a>
            <a href="#" class="hover:text-red-700 transition-colors">Contact</a>
            <a href="#" class="hover:text-red-700 transition-colors">Support</a>
          </div>

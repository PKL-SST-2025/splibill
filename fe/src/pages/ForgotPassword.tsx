  ...
  return (
    <div class="min-h-screen bg-black relative overflow-hidden">
      ...
      <div class="absolute inset-0 overflow-hidden">
        <div class="absolute -top-4 -right-4 w-72 h-72 bg-pink-300/15 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            {!isEmailSent() ? (
              <>
                ...
                <div class="relative mb-6">
                  ...
                  <div class="relative w-24 h-24 mx-auto rounded-full border-4 border-pink-300/50 overflow-hidden bg-gradient-to-br from-pink-300 to-pink-400 shadow-2xl flex items-center justify-center">
                    <Mail class="w-12 h-12 text-gray-800" />
                  </div>
                </div>
                ...
                <button
                  ...
                  class="group relative w-full bg-pink-300 text-gray-800 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl overflow-hidden"
              ...
              <>
                ...
                <div class="text-center mb-8">
                  ...
                  <p class="text-white font-semibold text-sm bg-gray-900/20 rounded-xl px-4 py-2 border border-pink-300/30">
                    {email()}
                  </p>
                </div>

                {/* Instructions */}
                <div class="bg-gray-900/10 rounded-2xl p-4 mb-6 border border-pink-300/20">
                  <p class="text-pink-100 text-sm leading-relaxed">
                ...
                <button
                  ...
                  class="group relative w-full bg-gray-900/20 text-white py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl overflow-hidden border border-pink-300/30 hover:bg-gray-800/30"
                  disabled={isLoading()}
                >
          ...
          <div class="mt-8 text-center">
            <div class="bg-gray-900/10 backdrop-blur-sm rounded-2xl p-6 border border-pink-300/20">
